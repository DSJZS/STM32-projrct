 ...
 * min(int a, int b)
 */
#if defined STM32_MPU6050   //  STM32使用此库需要定义 STM32_MPU6050 宏( inv_mpu.h 的第24行已经定义了 )
#include "./i2c/bsp_i2c.h"  
#include "./systick/bsp_SysTick.h"
   
#define i2c_write   Sensors_I2C_WriteRegister
#define i2c_read    Sensors_I2C_ReadRegister 
//#define delay_ms    mdelay    //  bsp_SysTick.h   已经定义了改宏，所以注释此行避免重复定义
